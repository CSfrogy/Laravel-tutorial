        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-8"
                             src="https://api.logo.com/api/v2/images?design=lg_t5ZbFe162KCEbKFyVL&u=d3644cf126dd4520d76bc62ee590e0532b2377482c2b93f9995b6bb7e164cfa5&width=500&height=400&margins=100&fit=contain&format=webp&quality=60&tightBounds=true"
                             alt="Your Company">
                    </div>
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="text-sm font-medium text-gray-400">LarryRobot@gmail.com</div>
                    </div>
                    <button type="button"
